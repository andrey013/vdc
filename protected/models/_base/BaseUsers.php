...
/**
 * This is the model base class for the table "vdc_users".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "Users".
 *
 * Columns in table "vdc_users" available as properties of the model,
 * followed by relations of table "vdc_users" available as properties of the model.
 *
 * @property integer $id
...
abstract class BaseUsers extends GxActiveRecord {
	...
	public function relations() {
		return array(
			...
			'orders1' => array(self::HAS_MANY, 'Order', 'manager_id'),

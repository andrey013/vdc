...
/**
 * This is the model base class for the table "vdc_profiles_field".
 * DO NOT MODIFY THIS FILE! It is automatically generated by giix.
 * If any changes are necessary, you must set or override the required
 * property or method in class "ProfilesField".
 *
 * Columns in table "vdc_profiles_field" available as properties of the model,
 ...
 *
 */
abstract class BaseProfilesField extends GxActiveRecord {
	...
	public function tableName() {
		return 'vdc_profiles_field';
	}

	public static function label($n = 1) {
		return Yii::t('app', 'ProfilesField|ProfilesFields', $n);
	}

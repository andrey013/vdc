...
<script>
	$(function(){
		datagrid = new DatabaseGrid({
			fetchUrl: "<?php echo $this->createUrl('/orderType/jsonlist'); ?>",
			updateUrl: "<?php echo $this->createUrl('/orderType/jsonupdate/'); ?>",
			init:
				function(grid){
	...
	?>
		...
		<div class="modal-body">
			<div class="control-group">
				<label class="control-label" for="OrderType_name">Название</label>
				<div class="controls">

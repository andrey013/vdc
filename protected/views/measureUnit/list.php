...
<script>
	$(function(){
		datagrid = new DatabaseGrid({
			fetchUrl: "<?php echo $this->createUrl('/measureUnit/jsonlist'); ?>",
			updateUrl: "<?php echo $this->createUrl('/measureUnit/jsonupdate/'); ?>",
			init:
				function(grid){
	...
	?>
		...
		<div class="modal-body">
			<div class="control-group">
				<label class="control-label" for="MeasureUnit_name">Название</label>
				<div class="controls">
			...
			<div class="control-group">
				<label class="control-label" for="MeasureUnit_sort_order">Порядок сортировки</label>
				<div class="controls">

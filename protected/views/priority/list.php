...
<script>
	$(function(){
		datagrid = new DatabaseGrid({
			fetchUrl: "<?php echo $this->createUrl('/priority/jsonlist'); ?>",
			updateUrl: "<?php echo $this->createUrl('/priority/jsonupdate/'); ?>",
			init:
				function(grid){
	...
	?>
		...
		<div class="modal-body">
			<div class="control-group">
				<label class="control-label" for="Priority_name">Название</label>
				<div class="controls">
			...
			<div class="control-group">
				<label class="control-label" for="Priority_code">Шифр</label>
				<div class="controls">
			...
			<div class="control-group">
				<label class="control-label" for="Priority_sort_order">Порядок сортировки</label>
				<div class="controls">
					<!-- <input type="password" id="password" placeholder="Пароль"> -->
